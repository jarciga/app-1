<?php
/**
* Menu page for optimizeMember Pro ( Google Buttons page ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_google_buttons"))
	{
		/**
		* Menu page for optimizeMember Pro ( Google Buttons page ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_google_buttons
			{
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_google_buttons ();
?>