<?php
/**
 * Menu page for optimizeMember Pro (PayPal options, Reminder Email).
 *
 * Copyright: © 2009-2011
...
if(!class_exists("c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_reminder_email"))
{
	/**
	 * Menu page for optimizeMember Pro (PayPal options, Reminder Email).
	 *
	 ...
	 * @since 151203
	 */
	class c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_reminder_email
	{
...
new c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_reminder_email ();
