/**
 * Core JavaScript routines for OptimizeMember Pro menu pages.
 *
 * Copyright: © 2009-2011
...
jQuery(document).ready(
    function($)
    {
        ...
        if(location.href.match(/page\=ws-plugin--optimizemember-.+?-ops/))
        {
            $('#ws-plugin--optimizemember-pro-eot-reminder-email-enable').on('change', function(){
            ...
            var $eot_reminder_email_day = $('#ws-plugin--optimizemember-pro-eot-reminder-email-day'),
                $eot_reminder_email_day_tabs = $eot_reminder_email_day.find('.-tabs');

            var $eot_reminder_email_days = $('#ws-plugin--optimizemember-pro-eot-reminder-email-days'),

                $eot_reminder_email_recipients = $('#ws-plugin--optimizemember-pro-eot-reminder-email-recipients'),
                eot_reminder_email_recipients = $eot_reminder_email_recipients.length ? $.JSON.parse($eot_reminder_email_recipients.val()) : {},

                $eot_reminder_email_recipients_for_day = $('#ws-plugin--optimizemember-pro-eot-reminder-email-recipients-for-day'),
                ...
                $eot_reminder_email_subject = $('#ws-plugin--optimizemember-pro-eot-reminder-email-subject'),
                eot_reminder_email_subject = $eot_reminder_email_subject.length ? $.JSON.parse($eot_reminder_email_subject.val()) : {},

                $eot_reminder_email_subject_for_day = $('#ws-plugin--optimizemember-pro-eot-reminder-email-subject-for-day'),
                ...
                $eot_reminder_email_message = $('#ws-plugin--optimizemember-pro-eot-reminder-email-message'),
                eot_reminder_email_message = $eot_reminder_email_message.length ? $.JSON.parse($eot_reminder_email_message.val()) : {},

                $eot_reminder_email_message_for_day = $('#ws-plugin--optimizemember-pro-eot-reminder-email-message-for-day'),
        ...
        if(location.href.match(/page\=ws-plugin--optimizemember-pro-coupon-codes/))
        {
            ...
            $menuTable.find('form').on('submit', function(e)
            {
                ...
                //UI Changes from S2Member caused the issue with saving coupon code
                //$('#ws-plugin--optimizemember-pro-coupon-codes').val(list);
            });
