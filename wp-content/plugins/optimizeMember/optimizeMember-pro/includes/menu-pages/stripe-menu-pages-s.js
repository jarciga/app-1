...
jQuery(document).ready(
    function($)
    {
        ...
        if(location.href.match(/page\=ws-plugin--optimizemember-pro-stripe-ops/))
        {
            $('select#ws-plugin--optimizemember-auto-eot-system-enabled')
                .change(function()
                {
        ...
        else if(location.href.match(/page\=ws-plugin--optimizemember-pro-stripe-forms/))
        {
            var taxMayApply = ('<?php echo (int)c_ws_plugin__optimizemember_pro_stripe_utilities::tax_may_apply(); ?>' == '1');
            ...
            ws_plugin__optimizemember_pro_stripeFormGenerate = function(form/* Handles Stripe Form Generation. */)
            {
                var shortCodeTemplate = '[optimizeMember-Pro-Stripe-Form %%attrs%% coupon="" accept_coupons="0" default_country_code="US" captcha="0" /]', shortCodeTemplateAttrs = '', labels = {};
            ...
            ws_plugin__optimizemember_pro_stripeCcapFormGenerate = function(form/* Handles Stripe Form Generation. */)
            {
                var shortCodeTemplate = '[optimizeMember-Pro-Stripe-Form %%attrs%% coupon="" accept_coupons="0" default_country_code="US" captcha="0" /]', shortCodeTemplateAttrs = '';
            ...
            ws_plugin__optimizemember_pro_stripeSpFormGenerate = /* Handles Stripe Form Generation. */ function()
            {
                var shortCodeTemplate = '[optimizeMember-Pro-Stripe-Form %%attrs%% coupon="" accept_coupons="0" default_country_code="US" captcha="0" /]', shortCodeTemplateAttrs = '';
            ...
            ws_plugin__optimizemember_pro_stripeRegLinkGenerate = /* Handles Stripe Link Generation. */ function()
            {
            ...
            ws_plugin__optimizemember_pro_stripeSpLinkGenerate = /* Handles Stripe Link Generation. */ function()
            {
