<?php
/**
 * Menu page for  (Stripe Options page).
 */
if(realpath(__FILE__) === realpath($_SERVER['SCRIPT_FILENAME']))
	exit ('Do not access this file directly.');

if(!class_exists('c_ws_plugin__optimizemember_pro_menu_page_stripe_ops'))
{
	/**
	 * Menu page for OptimizeMember Pro (Stripe Options page).
	 */
	class c_ws_plugin__optimizemember_pro_menu_page_stripe_ops
	{
		public function __construct()
		{
			...
			c_ws_plugin__optimizemember_menu_pages_tb::display();
			echo '</div>'."\n";*/
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-pro-stripe-account-details-section">'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-secret-key">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="password" autocomplete="off" name="ws_plugin__optimizemember_pro_stripe_api_secret_key" id="ws-plugin--optimizemember-pro-stripe-api-secret-key" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_secret_key']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-publishable-key">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_stripe_api_publishable_key" id="ws-plugin--optimizemember-pro-stripe-api-publishable-key" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_publishable_key']).'" /><br />'."\n";
			echo 'You\'ll find this in your Stripe Merchant account, under: <code>Account Settings -› API Keys</code>.'."\n";
			echo '</td>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-image">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_stripe_api_image" id="ws-plugin--optimizemember-pro-stripe-api-image" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_image']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-statement-description">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" maxlength="15" name="ws_plugin__optimizemember_pro_stripe_api_statement_description" id="ws-plugin--optimizemember-pro-stripe-api-statement-description" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_statement_description']).'" placeholder="MYCOMPANY-INC" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-validate-zipcode">'."\n";
			...
			echo '<td>'."\n";
			echo '<select name="ws_plugin__optimizemember_pro_stripe_api_validate_zipcode" id="ws-plugin--optimizemember-pro-stripe-api-validate-zipcode">'."\n";
			echo '<option value="0"'.((!$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_validate_zipcode']) ? ' selected="selected"' : '').'>No, do NOT validate a customer\'s billing zipcode (default Stripe behavior)</option>'."\n";
			echo '<option value="1"'.(($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_validate_zipcode']) ? ' selected="selected"' : '').'>Yes, validate the customer\'s zipcode to be sure it matches the card\'s billing address</option>'."\n";
			echo '</select>'."\n";
			echo '</td>'."\n";
			...
			echo '<tr>'."\n";
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-billing-address">'."\n";
			...
			echo '<tr>'."\n";
			echo '<td>'."\n";
			echo '<select name="ws_plugin__optimizemember_pro_stripe_api_billing_address" id="ws-plugin--optimizemember-pro-stripe-api-billing-address">'."\n";
			echo '<option value="0"'.((!$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_billing_address']) ? ' selected="selected"' : '').'>No, do not collect a customer\'s billing address (default Stripe behavior)</option>'."\n";
			echo '<option value="1"'.(($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_billing_address']) ? ' selected="selected"' : '').'>Yes, collect the customer\'s full billing address</option>'."\n";
			echo '</select>'."\n";
			echo '</td>'."\n";
			echo '</tr>'."\n";
			echo '<tr>'."\n";
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-stripe-api-shipping-address">'."\n";
			...
			echo '<tr>'."\n";
			echo '<td>'."\n";
			echo '<select name="ws_plugin__optimizemember_pro_stripe_api_shipping_address" id="ws-plugin--optimizemember-pro-stripe-api-shipping-address">'."\n";
			echo '<option value="0"'.((!$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_shipping_address']) ? ' selected="selected"' : '').'>No, do not collect a customer\'s shipping address (default Stripe behavior)</option>'."\n";
			echo '<option value="1"'.(($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_shipping_address']) ? ' selected="selected"' : '').'>Yes, collect the customer\'s full shipping address</option>'."\n";
			echo '</select>'."\n";
			echo '</td>'."\n";
			echo '</tr>'."\n";
			...
			echo '<label for="ws-plugin--optimizemember-pro-stripe-sandbox">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="radio" name="ws_plugin__optimizemember_pro_stripe_sandbox" id="ws-plugin--optimizemember-pro-stripe-sandbox-0" value="0"'.((!$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_sandbox']) ? ' checked="checked"' : '').' /> <label for="ws-plugin--optimizemember-pro-stripe-sandbox-0">No</label> &nbsp;&nbsp;&nbsp; <input type="radio" name="ws_plugin__optimizemember_pro_stripe_sandbox" id="ws-plugin--optimizemember-pro-stripe-sandbox-1" value="1"'.(($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_sandbox']) ? ' checked="checked"' : '').' /> <label for="ws-plugin--optimizemember-pro-stripe-sandbox-1">Yes, enable support for Sandbox testing.</label><br />'."\n";
			echo '<em>Only enable this if you\'ve provided test credentials above. This puts OptimizeMember\'s Stripe integration into Sandbox/Test mode. </em>'."\n";
			echo '</td>'."\n";
			...
			if(!is_multisite() || !c_ws_plugin__optimizemember_utils_conds::is_multisite_farm() || is_main_site())
			{
				...
				echo '<em>This enables API, Webhook/IPN and Return Page logging. The log files are stored here: <code>'.esc_html(c_ws_plugin__optimizemember_utils_dirs::doc_root_path($GLOBALS['WS_PLUGIN__']['optimizemember']['c']['logs_dir'])).'</code></em><br />'."\n";
				echo '<em class="ws-menu-page-hilite">If you have any trouble, please review your OptimizeMember log files for problems. See: <a href="'.esc_attr(admin_url('/admin.php?page=ws-plugin--optimizemember-logs')).'">Log Viewer</a></em>'."\n";
				echo '</td>'."\n";
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-pro-stripe-ipn-section">'."\n";
			echo '<a href="https://stripe.com/us/features" target="_blank"><img src="'.esc_attr($GLOBALS["WS_PLUGIN__"]["optimizemember_pro"]["c"]["dir_url"]).'/images/stripe-logo.png" class="ws-menu-page-right" style="width:250px; height:116px; background:#0D1F2F; border-radius:5px; border:0; margin-bottom:10px;" alt="." /></a>'."\n";
			...
			echo '<p>Your Stripe Webhook URL is:<br /><code>'.esc_html(site_url('/?optimizemember_pro_stripe_notify=1')).'</code></p>'."\n";
			echo '<div class="info" style="margin-bottom:0;">'."\n";
			echo '<p>If you are currently in Test/Sandbox mode (i.e. you gave OptimizeMember Test API Credentials); please choose the <code>Test</code> option when entering the Webhook URL in your Stripe Dashboard. Otherwise, under normal circumstances you will want to choose <code>Live</code>.</p>'."\n";
			echo '</div>'."\n";
			echo '</div>'."\n";
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-pro-signup-confirmation-email-section">'."\n";
			echo '<h3>Signup Confirmation Email (required, but the default works fine)<br />— specifically for OptimizeMember Pro Form integrations</h3>'."\n";
			echo '<p>This email is sent to new Customers after they successfully complete a Stripe "Pro Form" submission on your site. The <strong>primary</strong> purpose of this email, is to provide the Customer with a receipt, and NOT to send them a <code>%%registration_url%%</code>, because OptimizeMember\'s Stripe Pro Form integration handles that automatically; based on scenario. You may want to customize this email further, by providing details that are specifically geared to your site.</p>'."\n";

			echo '<p><em class="ws-menu-page-bright-hilite">* This email configuration is universally applied to all Payment Gateway integrations. [ <a href="#" onclick="alert(\'This configuration panel may ALSO appear under (OptimizeMember -› PayPal Options). Feel free to configure this email here; but please remember that this configuration is applied universally (i.e. SHARED) among all Payment Gateways integrated with OptimizeMember Pro Forms.\'); return false;">?</a> ]</em></p>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-signup-email-recipients">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_signup_email_recipients" id="ws-plugin--optimizemember-pro-signup-email-recipients" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_signup_email_recipients']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-signup-email-subject">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_signup_email_subject" id="ws-plugin--optimizemember-pro-signup-email-subject" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_signup_email_subject']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-signup-email-message">'."\n";
			...
			echo '<td>'."\n";
			echo '<textarea name="ws_plugin__optimizemember_pro_signup_email_message" id="ws-plugin--optimizemember-pro-signup-email-message" rows="10">'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_signup_email_message']).'</textarea><br />'."\n";
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-modification-confirmation-email-section">'."\n";
			echo '<h3>Modification Confirmation Email (required, but the default works fine)</h3>'."\n";
			echo '<p>This email is sent to existing Users after they complete an upgrade/downgrade (if and when you make this possible). For instance, if a Free Subscriber upgrades to a paid Membership Level, OptimizeMember considers this a Modification (NOT a Signup; a Signup is associated only with someone completely new). The <strong>primary</strong> purpose of this email is to provide the Customer with a confirmation that their account was updated. You may also customize this further by providing details that are specifically geared to your site.</p>'."\n";

			echo '<p><em class="ws-menu-page-bright-hilite">* The email configuration below is universally applied to all Payment Gateway integrations. [ <a href="#" onclick="alert(\'This configuration panel may ALSO appear under (OptimizeMember -› PayPal Options). Feel free to configure this email here; but please remember that this configuration is applied universally (i.e. SHARED) among all Payment Gateways integrated with OptimizeMember.\'); return false;">?</a> ]</em></p>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-modification-email-recipients">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_modification_email_recipients" id="ws-plugin--optimizemember-modification-email-recipients" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['modification_email_recipients']).'" /><br />'."\n";
			echo 'This is a semicolon ( ; ) delimited list of Recipients. Here is an example:<br />'."\n";
			echo '<code>"%%full_name%%" &lt;%%payer_email%%&gt;; admin@example.com; "Webmaster" &lt;webmaster@example.com&gt;</code>'."\n";
			echo '</td>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-modification-email-subject">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_modification_email_subject" id="ws-plugin--optimizemember-modification-email-subject" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['modification_email_subject']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-modification-email-message">'."\n";
			...
			echo '<td>'."\n";
			echo '<textarea name="ws_plugin__optimizemember_modification_email_message" id="ws-plugin--optimizemember-modification-email-message" rows="10">'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['modification_email_message']).'</textarea><br />'."\n";
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-ccap-confirmation-email-section">'."\n";
			echo '<h3>Capability Confirmation Email (required, but the default works fine)</h3>'."\n";
			echo '<p>This email is sent to existing Users after they complete a Buy Now purchase for one or more Custom Capabilities (if and when you make this possible); see: <code>Dashboard -› OptimizeMember -› Stripe Forms -› Capability (Buy Now)</code>. The <strong>primary</strong> purpose of this email is to provide the Customer with a confirmation that their account was updated. You may also customize this further by providing details that are specifically geared to your site.</p>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-ccap-email-recipients">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_ccap_email_recipients" id="ws-plugin--optimizemember-ccap-email-recipients" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['ccap_email_recipients']).'" /><br />'."\n";
			echo 'This is a semicolon ( ; ) delimited list of Recipients. Here is an example:<br />'."\n";
			echo '<code>"%%full_name%%" &lt;%%payer_email%%&gt;; admin@example.com; "Webmaster" &lt;webmaster@example.com&gt;</code>'."\n";
			echo '</td>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-ccap-email-subject">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_ccap_email_subject" id="ws-plugin--optimizemember-ccap-email-subject" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['ccap_email_subject']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-ccap-email-message">'."\n";
			...
			echo '<td>'."\n";
			echo '<textarea name="ws_plugin__optimizemember_ccap_email_message" id="ws-plugin--optimizemember-ccap-email-message" rows="10">'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['ccap_email_message']).'</textarea><br />'."\n";
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-pro-sp-confirmation-email-section">'."\n";
			echo '<h3>Specific Post/Page Confirmation Email (required, but the default works fine)<br />— specifically for OptimizeMember Pro Form integrations</h3>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-sp-email-recipients">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_sp_email_recipients" id="ws-plugin--optimizemember-pro-sp-email-recipients" value="'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_sp_email_recipients']).'" /><br />'."\n";
			echo 'This is a semicolon ( ; ) delimited list of Recipients. Here is an example:<br />'."\n";
			echo '<code>"%%full_name%%" &lt;%%payer_email%%&gt;; admin@example.com; "Webmaster" &lt;webmaster@example.com&gt;</code>'."\n";
			echo '</td>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-sp-email-subject">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_sp_email_subject" id="ws-plugin--optimizemember-pro-sp-email-subject" value="'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_sp_email_subject']).'" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-sp-email-message">'."\n";
			...
			echo '<td>'."\n";
			echo '<textarea name="ws_plugin__optimizemember_pro_sp_email_message" id="ws-plugin--optimizemember-pro-sp-email-message" rows="10">'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_sp_email_message']).'</textarea><br />'."\n";
			...
			echo '<li><code>%%txn_id%%</code> = The Stripe Transaction ID. Stripe assigns a unique identifier for every purchase.</li>'."\n";
			echo '<li><code>%%txn_cid%%</code> = Applicable only with Stripe integration. This is the Customer\'s ID in Stripe. Each Stripe Customer has this Customer ID; and also a Transaction ID associated with their purchase of a Specific Post/Page [ <a href="#" onclick="alert(\'Applicable only when you integrate OptimizeMember with Stripe. In all other cases, the %%txn_cid%% is simply set to the %%txn_id%% value; i.e. it is a duplicate of %%txn_id%% when running anything other than Stripe.\\n\\nEach Stripe Customer has a Customer ID; and also a Transaction ID. See %%txn_id%% for further details.\'); return false;">?</a> ]</li>'."\n";
			...
			echo '<h3>Tax Rate Calculations for Stripe Pro Forms (optional)<br />— specifically for OptimizeMember Pro Form integrations</h3>'."\n";
			echo '<p>With Stripe, your software (OptimizeMember Pro) is solely responsible for calculating Tax Rates. In the fields below, you can set a Global Default Tax Rate, and/or a "Custom Tax Configuration File"; which can be applied to specific countries, specific states, provinces, and even to specific zip code ranges. * Tax Rate calculations are fully compatible with international currencies and locations.</p>'."\n";
			echo '<p>When you create a Stripe Pro Form with OptimizeMember, you\'ll be asked to supply a <em>Charge Amount</em>. Then, during checkout... OptimizeMember calculates Tax. The calculated Tax Rate is added to the <em>Charge Amount</em> in your Stripe Pro Form Shortcode. The Tax Rate will be displayed to a Customer during checkout, <strong>after</strong> they\'ve supplied a Billing Address. For example, if you create a Stripe Pro Form that charges a Customer <strong>$24.95</strong>, and the Tax Rate is configured as 7.0%; OptimizeMember will automatically calculate the Tax as $1.75. A Customer will pay the Total Amount (<em>Charge</em> + Tax = <strong>$26.70</strong>).</p>'."\n";
			...
			echo '<p><em class="ws-menu-page-bright-hilite">* This tax configuration is universally applied to all Payment Gateway integrations. [ <a href="#" onclick="alert(\'This configuration panel may ALSO appear under (OptimizeMember -› PayPal Options). Feel free to configure taxes here; but please remember that this configuration is applied universally (i.e. SHARED) among all Payment Gateways integrated with OptimizeMember Pro Forms.\'); return false;">?</a> ]</em></p>'."\n";
			...
			echo '<td>'."\n";
			// hook for adding a button to fill the tax rates
			do_action('opm_add_eu_tax_rates');
			...
			echo '<p>EOT = End Of Term. By default, OptimizeMember will demote a paid Member to a Free Subscriber whenever their Subscription term has ended (i.e. expired) or is cancelled. OptimizeMember demotes them to a Free Subscriber, so they will no longer have Member Level Access to your site. However, in some cases, you may prefer to have Customer accounts deleted completely, instead of just being demoted. This is where you choose which method works best for your site. If you don\'t want OptimizeMember to take ANY action at all, you can disable OptimizeMember\'s EOT System temporarily, or even completely. There are also a few other configurable options here, so please read carefully. These options are all very important.</p>'."\n";
			echo '<p>Your Stripe Webhook (aka: IPN) integration will assist in notifying OptimizeMember whenever a Subscription expires. For example, if a Customer cancels their own Subscription; or if you cancel/delete a Customer\'s Subscription through Stripe, OptimizeMember will eventually be notified. The account for that Customer will either be demoted to a Free Subscriber, or deleted automatically (based on your configuration). ~ Otherwise, under normal circumstances, OptimizeMember will not process an EOT until the User has completely used up the time they paid for.</em></p>'."\n";
			...
			echo '<p><em class="ws-menu-page-bright-hilite">* These options are universally applied to all Payment Gateway integrations. [ <a href="#" onclick="alert(\'These settings may ALSO appear under (OptimizeMember -› PayPal Options). Feel free to configure them here; but please remember that these configuration options are applied universally (i.e. they\\\'re SHARED) among all Payment Gateways integrated with OptimizeMember.\'); return false;">?</a> ]</em></p>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-eots-remove-ccaps">'."\n";
			...
			echo '<td>'."\n";
			echo '<select name="ws_plugin__optimizemember_eots_remove_ccaps" id="ws-plugin--optimizemember-eots-remove-ccaps">'."\n";
			echo '<option value="1"'.((@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['eots_remove_ccaps']) ? ' selected="selected"' : '').'>Yes (an EOT also results in the loss of any Custom Capabilities a User/Member may have)</option>'."\n";
			echo '<option value="0"'.((!@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['eots_remove_ccaps']) ? ' selected="selected"' : '').'>No (an EOT has no impact on any Custom Capabilities a User/Member may have)</option>'."\n";
			echo '</select>'."\n";
			echo '</td>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-eot-grace-time">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_eot_grace_time" id="ws-plugin--optimizemember-eot-grace-time" value="'.format_to_edit(@$GLOBALS['WS_PLUGIN__']['optimizemember']['o']['eot_grace_time']).'" /><br />'."\n";
			...
			echo '<option value="none"'.(($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["triggers_immediate_eot"] === "none") ? ' selected="selected"' : '').'>None (I\'ll review these events manually)</option>'."\n";
			echo '<option value="refunds"'.(($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["triggers_immediate_eot"] === "refunds") ? ' selected="selected"' : '').'>Full Refunds (full refunds only; ALWAYS trigger an Immediate EOT action)</option>'."\n";
			echo '<option value="reversals"'.(($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["triggers_immediate_eot"] === "reversals") ? ' selected="selected"' : '').'>Reversals (chargebacks only; ALWAYS trigger an Immediate EOT action)</option>'."\n";
			echo '<option value="refunds,reversals"'.(($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["triggers_immediate_eot"] === "refunds,reversals") ? ' selected="selected"' : '').'>Full Refunds, Reversals (these ALWAYS trigger an Immediate EOT action)</option>'."\n";
			echo '<option value="refunds,partial_refunds,reversals"'.(($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["triggers_immediate_eot"] === "refunds,partial_refunds,reversals") ? ' selected="selected"' : '').'>Full Refunds, Partial Refunds, Reversals (these ALWAYS trigger an Immediate EOT action)</option>'."\n";
			echo '</select><br />'."\n";
			echo '<em><strong>Note:</strong> OptimizeMember is not equipped to detect partial refunds against multi-payment Subscriptions reliably. Therefore, all refunds processed against Subscriptions (of any kind) are considered <strong>Partial</strong> Refunds. Full refunds (in the eyes of OptimizeMember) occur only against Buy Now transactions where it is easy for OptimizeMember to see that the refund amount is &gt;= the original Buy Now purchase price (i.e. a Full Refund). <strong>Also Note:</strong> This setting (no matter what you choose) will NOT impact OptimizeMember\'s internal API Notifications for Refund/Reversal events. <a href="#" onclick="alert(\'A Full or Partial Refund; and/or a Reversal Notification will ALWAYS be processed internally by OptimizeMember, even if no action is taken by OptimizeMember in accordance with your configuration here.\\n\\nIn this way, you\\\'ll have the full ability to listen for these events on your own (via API Notifications); if you prefer (optional). For more information, check your Dashboard under: `OptimizeMember -› API Notifications -› Refunds/Reversals`.\'); return false;">Click here for details</a>.</em>'."\n";
			echo '</td>'."\n";
			...
			echo '<div class="ws-menu-page-section ws-plugin--optimizemember-pro-eot-reminder-email-section">'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-eot-reminder-email-enable">'."\n";
			...
			echo '<td>'."\n";
			echo '<select name="ws_plugin__optimizemember_pro_eot_reminder_email_enable" id="ws-plugin--optimizemember-pro-eot-reminder-email-enable">'."\n";
			echo '<option value="0"'.(($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_eot_reminder_email_enable'] === "0") ? ' selected="selected"' : '').'>No (disabled)</option>'."\n";
			echo '<option value="1"'.(($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_eot_reminder_email_enable'] === "1") ? ' selected="selected"' : '').'>Yes (enable)</option>'."\n";
			echo '</select>'."\n";
			echo '</td>'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-eot-reminder-email-days">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="text" autocomplete="off" name="ws_plugin__optimizemember_pro_eot_reminder_email_days" id="ws-plugin--optimizemember-pro-eot-reminder-email-days" value="'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_eot_reminder_email_days']).'" /><br />'."\n";
			...
			echo '<div id="ws-plugin--optimizemember-pro-eot-reminder-email-day">'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-eot-reminder-email-recipients-for-day">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="hidden" name="ws_plugin__optimizemember_pro_eot_reminder_email_recipients" id="ws-plugin--optimizemember-pro-eot-reminder-email-recipients" value="'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_eot_reminder_email_recipients']).'" />'."\n";
			echo '<input type="text" autocomplete="off" id="ws-plugin--optimizemember-pro-eot-reminder-email-recipients-for-day" value="" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-eot-reminder-email-subject-for-day">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="hidden" name="ws_plugin__optimizemember_pro_eot_reminder_email_subject" id="ws-plugin--optimizemember-pro-eot-reminder-email-subject" value="'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_eot_reminder_email_subject']).'" />'."\n";
			echo '<input type="text" autocomplete="off" id="ws-plugin--optimizemember-pro-eot-reminder-email-subject-for-day" value="" /><br />'."\n";
			...
			echo '<th>'."\n";
			echo '<label for="ws-plugin--optimizemember-pro-eot-reminder-email-message-for-day">'."\n";
			...
			echo '<td>'."\n";
			echo '<input type="hidden" name="ws_plugin__optimizemember_pro_eot_reminder_email_message" id="ws-plugin--optimizemember-pro-eot-reminder-email-message" value="'.format_to_edit($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_eot_reminder_email_message']).'" />'."\n";
			echo '<textarea id="ws-plugin--optimizemember-pro-eot-reminder-email-message-for-day" rows="10"></textarea><br />'."\n";
			...
			echo '<li><code>%%user_ip%%</code> = The Customer\'s original IP Address, during checkout/registration via <code>$_SERVER["REMOTE_ADDR"]</code>.</li>'."\n";
			echo '<li><code>%%user_id%%</code> = A unique WordPress User ID that references this account in the WordPress database.</li>'."\n";
			echo '<li><code>%%user_role%%</code> = The Role that this user has on your site; e.g., <code>optimizemember_level1</code>, <code>optimizemember_level2</code>, etc.</li>'."\n";
			...
			echo '<p class="submit"><input class="op-pb-button green" type="submit" value="Save All Changes" /></p>'."\n";
...
new c_ws_plugin__optimizemember_pro_menu_page_stripe_ops ();