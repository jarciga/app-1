...
/**/
if(!class_exists("c_ws_plugin__optimizemember_pro_imports"))
	{
		/**
		* Handles various importations.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_imports
			{
				/**
				* Handles various importations.
				*
				...
				*/
				public static function import()
					{
						if(!empty($_POST["ws_plugin__optimizemember_pro_import_users"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_imports_in::import_users();
							}
						if(!empty($_POST["ws_plugin__optimizemember_pro_import_ops"])) /* Call routine? */
							{
								return c_ws_plugin__optimizemember_pro_imports_in::import_ops();
							}
					}
			}
	}
