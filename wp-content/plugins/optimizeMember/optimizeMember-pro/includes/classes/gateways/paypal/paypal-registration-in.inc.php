...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_registration_in"))
	{
		/**
		* PayPal Registration Form ( inner processing routines ).
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_registration_in
			{
				/**
				...
				*/
				public static function paypal_registration ()
					{
						if (!empty ($_POST["optimizemember_pro_paypal_registration"]["nonce"]) && ($nonce = $_POST["optimizemember_pro_paypal_registration"]["nonce"]) && wp_verify_nonce ($nonce, "optimizemember-pro-paypal-registration"))
							{
								$GLOBALS["ws_plugin__optimizemember_pro_paypal_registration_response"] = array (); /* This holds the global response details. */
								$global_response = &$GLOBALS["ws_plugin__optimizemember_pro_paypal_registration_response"]; /* This is a shorter reference. */
								/**/
								...
								/**/
								if (!c_ws_plugin__optimizemember_pro_paypal_responses::paypal_form_attr_validation_errors ($post_vars["attr"])) /* Must NOT have any attr errors. */
									{
