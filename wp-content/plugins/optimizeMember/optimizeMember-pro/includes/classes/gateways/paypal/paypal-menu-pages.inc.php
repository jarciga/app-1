...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_menu_pages"))
	{
		/**
		* PayPal Menu Pages.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_menu_pages
			{
				/**
				...
				* @since 1.5
				*
				* @attaches-to ``add_filter("ws_plugin__optimizemember_during_add_admin_options_add_paypal_buttons_page");``
				*
				...
				*/
				public static function paypal_admin_options ($add_paypal_buttons_page = TRUE, $vars = FALSE)
					{
						add_submenu_page ($vars["menu"], "optimizeMember Pro / PayPal Pro Forms", "PayPal Pro-Forms", "create_users", "ws-plugin--optimizemember-pro-paypal-forms", "c_ws_plugin__optimizemember_pro_paypal_menu_pages::paypal_forms_page");
						/**/
						return $add_paypal_buttons_page; /* Now add the PayPal Buttons. */
					}
				/**
				* Builds PayPal Pro option details into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_during_paypal_account_details");``
				*
				...
				*/
				...
				/**
				* Builds PayPal Pro option detail rows into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_during_paypal_account_detail_rows");``
				*
				* @param array $vars Expects an array of defined variables passed through by the Action Hook.
				* @return null
				*/
				...
				/**
				* Builds PayPal Pro Sandbox tip into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_during_paypal_account_details_after_sandbox_tip");``
				*
				* @param array $vars Expects an array of defined variables passed through by the Action Hook.
				* @return null
				*/
				...
				/**
				* Builds PayPal Pro IPN tip into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_during_paypal_ipn_after_quick_tip");``
				*
				* @param array $vars Expects an array of defined variables passed through by the Action Hook.
				* @return null
				*/
				...
				/**
				* Builds PayPal Pro PDT tip into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_during_paypal_pdt_after_quick_tip");``
				*
				* @param array $vars Expects an array of defined variables passed through by the Action Hook.
				* @return null
				*/
				...
				/**
				* Builds the PayPal Pro Signup Confirmation Email into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_after_signup_confirmation_email");``
				*
				* @param array $vars Expects an array of defined variables passed through by the Action Hook.
				* @return null
				*/
				...
				/**
				* Builds the PayPal Pro Specific Post/Page Confirmation Email into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				* @attaches-to ``add_action("ws_plugin__optimizemember_during_paypal_ops_page_during_left_sections_after_sp_confirmation_email");``
				*
				* @param array $vars Expects an array of defined variables passed through by the Action Hook.
				* @return null
				*/
			...
			public static function paypal_ops_reminder_email($vars = array())
			{
				...
				/**
				* Builds the PayPal Pro Tax Configuration into optimizeMember.
				*
				* @package optimizeMember\Menu_Pages
				* @since 1.5
				*
				...
				*/
				public static function paypal_forms_page ()
					{
						if (c_ws_plugin__optimizemember_pro_paypal_responses::paypal_form_api_validation_errors ()) /* Report error if PayPal Options are not yet configured. */
