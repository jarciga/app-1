...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_notify_in"))
	{
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_notify_v2_1_in
			{
				/**
								...
								if (is_array ($clickbank = c_ws_plugin__optimizemember_pro_clickbank_utilities::clickbank_postvars ()) && ($_clickbank = $clickbank))
									{
										...
										$s2vars = c_ws_plugin__optimizemember_pro_clickbank_utilities::clickbank_parse_s2vars_v2_1($clickbank["cvendthru"], $clickbank["ctransaction"]);
