...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_notify"))
	{
		/**
		* ClickBank® IPN Handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_notify
			{
				/**
				...
				*/
                ...
                {
                    if(!empty($_GET['optimizemember_pro_clickbank_notify']))
                    {
                        if($_GET['optimizemember_pro_clickbank_notify'] === '6')
                            c_ws_plugin__optimizemember_pro_clickbank_notify_in::clickbank_notify();
                        else c_ws_plugin__optimizemember_pro_clickbank_notify_v2_1_in::clickbank_notify();
                    }
                }
			}
	}
