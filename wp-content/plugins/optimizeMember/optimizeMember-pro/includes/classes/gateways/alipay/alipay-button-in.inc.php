<?php
/**
* Shortcode `[optimizeMember-Pro-AliPay-Button /]` ( inner processing routines ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_alipay_button_in"))
	{
		/**
		* Shortcode `[optimizeMember-Pro-AliPay-Button /]` ( inner processing routines ).
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_alipay_button_in
			{
				/**
						...
						if /* Specific Post/Page Buttons. */ ($attr["sp"])
							{
								...
								/**/
								$code = preg_replace ("/%%url%%/", c_ws_plugin__optimizemember_utils_strings::esc_refs (esc_attr ($url = c_ws_plugin__optimizemember_pro_alipay_utilities::alipay_link_gen ($vars))), $code);
								/**/
