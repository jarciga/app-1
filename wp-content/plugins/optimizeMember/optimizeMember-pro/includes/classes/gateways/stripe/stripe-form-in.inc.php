<?php
/**
 * Shortcode `[optimizeMember-Pro-Stripe-Form /]` (inner processing routines).
 */
if(realpath(__FILE__) === realpath($_SERVER['SCRIPT_FILENAME']))
	exit('Do not access this file directly.');

if(!class_exists('c_ws_plugin__optimizemember_pro_stripe_form_in')) {
	/**
     * Shortcode `[optimizeMember-Pro-Stripe-Form /]` (inner processing routines).
     *
     ...
     * @since 140617
     */
	class c_ws_plugin__optimizemember_pro_stripe_form_in
    {
        /**
         * Shortcode `[optimizeMember-Pro-Stripe-xFormOption /]`.
         *
         * @package optimizeMember\Stripe
         * @since 140617
         *
         * @attaches-to ``add_shortcode('optimizeMember-Pro-Stripe-xFormOption');``
         *
        ...
        public static function sc_stripe_form_option($attr, $content = '', $shortcode = '')
        {
            ...
            return serialize(c_ws_plugin__optimizemember_utils_strings::trim_qts_deep((array)$attr)).'|::|';
        }
        ...
        public static function sc_stripe_form($attr, $content = '', $shortcode = '')
        {
            ...
            $attr = shortcode_atts(array(
                ...
                'register'                 => '0',
                'update'                   => '0',
                'accept'                   => $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_accept_bitcoin'] ? 'bitcoin' : '',
                'coupon'                   => '',
                'accept_coupons'           => '0',
                ...
                'template'                 => '',
                'success'                  => '',
                'validate_zipcode'         => $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_validate_zipcode'],
                'collect_billing_address'  => $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_billing_address'],
                'collect_shipping_address' => $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_shipping_address'],
                'reject_prepaid'           => $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['pro_stripe_api_validate_zipcode']
            ), $attr);
            ...
            $attr['success']              = c_ws_plugin__optimizemember_utils_urls::n_amps($attr['success']); // Normalize ampersands.
            ...
            else if($attr['register']) // Free registrations.
            {
                ...
                if($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['custom_reg_fields']) // Only display Custom Fields if configured.
            ...
            else if($attr['update']) // Billing information updates.
            {
                ...
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_update[source_token]" id="optimizemember-pro-stripe-update-source-token" value="'.esc_attr(@$_p['optimizemember_pro_stripe_update']['source_token']).'" />';
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_update[source_token_summary]" id="optimizemember-pro-stripe-update-source-token-summary" value="'.esc_attr(@$_p['optimizemember_pro_stripe_update']['source_token_summary']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-update-should-validate-zipcode" value="'.esc_attr($attr['validate_zipcode']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-update-should-collect-billing-address" value="'.esc_attr($attr['collect_billing_address']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-update-should-collect-shipping-address" value="'.esc_attr($attr['collect_shipping_address']).'" />';
                ...
                $code = preg_replace('/%%source_token%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs(esc_html(@$_p['optimizemember_pro_stripe_update']['source_token'])), $code);
                $code = preg_replace('/%%source_token_summary%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs(esc_html(@$_p['optimizemember_pro_stripe_update']['source_token_summary'])), $code);
                $code = preg_replace('/%%captcha%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs($captcha), $code);
                $code = preg_replace('/%%hidden_inputs%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs($hidden_inputs), $code);
            ...
            else if($attr['sp']) // Specific Post/Page Access.
            {
                ...
                $tax_may_apply = c_ws_plugin__optimizemember_pro_stripe_utilities::tax_may_apply(); // Tax may apply?
                $cp_attr       = $cp_buy_now_attr = c_ws_plugin__optimizemember_pro_stripe_utilities::apply_coupon($attr, $attr['coupon']);
                ...
                $is_buy_now_amount_in_cents  = $is_buy_now && $is_buy_now_amount > 0 ? (string)c_ws_plugin__optimizemember_pro_stripe_utilities::dollar_amount_to_cents($is_buy_now_amount, $is_buy_now_currency) : '0';
                ...
                // allow complete override of default_country_code by OPM VAT add on
                $default_country_v 			 = apply_filters('ws_plugin__optimizemember_pro_stripe_default_country', $country_default_by_currency, get_defined_vars());
                ...
                */
                ...
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_sp_checkout[source_token]" id="optimizemember-pro-stripe-sp-checkout-source-token" value="'.esc_attr($is_buy_now_amount <= 0 || @$_p['optimizemember_pro_stripe_sp_checkout']['source_token'] !== 'free' ? @$_p['optimizemember_pro_stripe_sp_checkout']['source_token'] : '').'" />';
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_sp_checkout[source_token_summary]" id="optimizemember-pro-stripe-sp-checkout-source-token-summary" value="'.esc_attr($is_buy_now_amount <= 0 || @$_p['optimizemember_pro_stripe_sp_checkout']['source_token'] !== 'free' ? @$_p['optimizemember_pro_stripe_sp_checkout']['source_token_summary'] : '').'" />';
                ...
                $hidden_inputs .= !$tax_may_apply ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-tax-not-required-or-not-possible" value="1" />' : '';
                $hidden_inputs .= $is_buy_now_amount <= 0 ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-payment-not-required-or-not-possible" value="1" />' : '';
                $hidden_inputs .= $is_buy_now_amount > 0 ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-is-buy-now-amount" value="'.esc_attr($is_buy_now_amount).'" />' : '';
                $hidden_inputs .= $is_buy_now_amount_in_cents > 0 ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-is-buy-now-amount-in-cents" value="'.esc_attr($is_buy_now_amount_in_cents).'" />' : '';
                $hidden_inputs .= $is_buy_now_currency ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-is-buy-now-currency" value="'.esc_attr($is_buy_now_currency).'" />' : '';
                $hidden_inputs .= $is_buy_now_desc ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-is-buy-now-desc" value="'.esc_attr($is_buy_now_desc).'" />' : '';
                $hidden_inputs .= $is_buy_now_bitcoin_accepted ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-is-buy-now-bitcoin-accepted" value="1" />' : '';
                $hidden_inputs .= (($cp_attr = c_ws_plugin__optimizemember_pro_stripe_utilities::apply_coupon($attr, $attr['coupon'])) && $cp_attr['ta'] <= 0.00 && $cp_attr['ra'] <= 0.00) ? '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-payment-not-required-or-not-possible" value="1" />' : '';
                ...
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-should-validate-zipcode" value="'.esc_attr($attr['validate_zipcode']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-should-collect-billing-address" value="'.esc_attr($attr['collect_billing_address']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-sp-checkout-should-collect-shipping-address" value="'.esc_attr($attr['collect_shipping_address']).'" />';
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_sp_checkout[attr]" id="optimizemember-pro-stripe-sp-checkout-attr" value="'.esc_attr(c_ws_plugin__optimizemember_utils_encryption::encrypt(serialize($attr))).'" />';
                ...
                $code = preg_replace('/%%source_token%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs(esc_html(@$_p['optimizemember_pro_stripe_sp_checkout']['source_token'])), $code);
                $code = preg_replace('/%%source_token_summary%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs(esc_html(@$_p['optimizemember_pro_stripe_sp_checkout']['source_token_summary'])), $code);
            ...
            else // Signups and Modifications.
            {
                ...
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_checkout[source_token]" id="optimizemember-pro-stripe-checkout-source-token" value="'.esc_attr(($cp_attr['ta'] <= 0 && $cp_attr['ra'] <= 0) || @$_p['optimizemember_pro_stripe_checkout']['source_token'] !== 'free' ? @$_p['optimizemember_pro_stripe_checkout']['source_token'] : '').'" />';
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_checkout[source_token_summary]" id="optimizemember-pro-stripe-checkout-source-token-summary" value="'.esc_attr(($cp_attr['ta'] <= 0 && $cp_attr['ra'] <= 0) || @$_p['optimizemember_pro_stripe_checkout']['source_token'] !== 'free' ? @$_p['optimizemember_pro_stripe_checkout']['source_token_summary'] : '').'" />';
                ...
                $hidden_inputs .= (($cp_attr = c_ws_plugin__optimizemember_pro_stripe_utilities::apply_coupon($attr, $attr['coupon'])) && $cp_attr['ta'] <= 0.00 && $cp_attr['ra'] <= 0.00) ? '<input type="hidden" id="optimizemember-pro-stripe-checkout-payment-not-required-or-not-possible" value="1" />' : '';
                $hidden_inputs .= $is_buy_now_amount > 0 ? '<input type="hidden" id="optimizemember-pro-stripe-checkout-is-buy-now-amount" value="'.esc_attr($is_buy_now_amount).'" />' : '';
                $hidden_inputs .= $is_buy_now_amount_in_cents > 0 ? '<input type="hidden" id="optimizemember-pro-stripe-checkout-is-buy-now-amount-in-cents" value="'.esc_attr($is_buy_now_amount_in_cents).'" />' : '';
                $hidden_inputs .= $is_buy_now_currency ? '<input type="hidden" id="optimizemember-pro-stripe-checkout-is-buy-now-currency" value="'.esc_attr($is_buy_now_currency).'" />' : '';
                $hidden_inputs .= $is_buy_now_desc ? '<input type="hidden" id="optimizemember-pro-stripe-checkout-is-buy-now-desc" value="'.esc_attr($is_buy_now_desc).'" />' : '';
                $hidden_inputs .= $is_buy_now_bitcoin_accepted ? '<input type="hidden" id="optimizemember-pro-stripe-checkout-is-buy-now-bitcoin-accepted" value="1" />' : '';
                ...
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-checkout-should-validate-zipcode" value="'.esc_attr($attr['validate_zipcode']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-checkout-should-collect-billing-address" value="'.esc_attr($attr['collect_billing_address']).'" />';
                $hidden_inputs .= '<input type="hidden" id="optimizemember-pro-stripe-checkout-should-collect-shipping-address" value="'.esc_attr($attr['collect_shipping_address']).'" />';
                $hidden_inputs .= '<input type="hidden" name="optimizemember_pro_stripe_checkout[attr]" id="optimizemember-pro-stripe-checkout-attr" value="'.esc_attr(c_ws_plugin__optimizemember_utils_encryption::encrypt(serialize($attr))).'" />';
                ...
                $code = preg_replace('/%%source_token%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs(esc_html(@$_p['optimizemember_pro_stripe_checkout']['source_token'])), $code);
                $code = preg_replace('/%%source_token_summary%%/', c_ws_plugin__optimizemember_utils_strings::esc_refs(esc_html(@$_p['optimizemember_pro_stripe_checkout']['source_token_summary'])), $code);
                ...
                if (!empty($raw_content)) {
                    //If user is using multiple stripe forms in one page we need to force default stripe button - $proFormCount
                    $proFormCount = substr_count($raw_content,'optimizeMember-Pro-Stripe-Form');
                    if (strpos($code,"xFormOption") !== false || $proFormCount <= 1){
