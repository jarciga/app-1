...
if (!function_exists ('wp_new_user_notification'))
{
	 ...
	 */
	if ($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['new_user_emails_enabled'])
	{
		function wp_new_user_notification()
		{
			...
			return call_user_func_array('c_ws_plugin__optimizemember_email_configs::new_user_notification', $args);
		}
		add_filter('wpmu_welcome_user_notification', 'c_ws_plugin__optimizemember_email_configs::new_user_notification', 10, 2);
	}
	$GLOBALS['WS_PLUGIN__']['optimizemember']['c']['pluggables']['wp_new_user_notification'] = true;
}
