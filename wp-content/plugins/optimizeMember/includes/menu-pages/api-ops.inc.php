<?php
/**
* Menu page for the optimizeMember plugin ( API Notifications page ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_menu_page_api_ops"))
	{
		/**
		* Menu page for the optimizeMember plugin ( API Notifications page ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_menu_page_api_ops
			{
						...
						if (apply_filters ("ws_plugin__optimizemember_during_api_ops_page_during_left_sections_display_signup_notifications", true, get_defined_vars ()))
							{
								...
								echo '<strong>Coupon Replacement Codes (applicable only with Pro-Forms):</strong>'."\n";
...
/**/
new c_ws_plugin__optimizemember_menu_page_api_ops ();
?>