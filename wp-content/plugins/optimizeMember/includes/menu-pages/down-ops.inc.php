<?php
/**
* Menu page for the optimizeMember plugin ( File Download Options page ).
*
* Copyright: © 2009-2011
...
/**/
if(!class_exists("c_ws_plugin__optimizemember_menu_page_down_ops"))
	{
		/**
		* Menu page for the optimizeMember plugin ( File Download Options page ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_menu_page_down_ops
			{
						...
						if(apply_filters("ws_plugin__optimizemember_during_down_ops_page_during_left_sections_display_amazon_cf", true, get_defined_vars()))
							{
								...
								/**/
								else if(!$GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["amazon_cf_files_distros_auto_config_status"])
...
/**/
new c_ws_plugin__optimizemember_menu_page_down_ops();
?>