...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_translations"))
	{
		/**
		* optimizeMember translations.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_translations
			{
				/**
				* Loads optimizeMember's text domain for translations.
				*
				* @package optimizeMember\Translations
				* @since 110815
				*
				...
				*/
				public static function load ()
					{
						load_plugin_textdomain ("s2member", false, c_ws_plugin__optimizemember_utils_dirs::rel_path (WP_PLUGIN_DIR, dirname (dirname (__FILE__)) . "/translations"));
						load_plugin_textdomain ("s2member"); /* Allows `.mo` file to be loaded from the `/wp-content/plugins/s2member-[locale].mo`. */
						/**/
						do_action ("ws_plugin__optimizemember_during_translations_load", get_defined_vars ());
						/**/
						add_filter ("gettext", "c_ws_plugin__optimizemember_translations::translation_mangler", 10, 3);
					/**/
					}
				/**
				...
				public static function translation_mangler ($translated = FALSE, $original = FALSE, $domain = FALSE)
					{
						...
						if(!did_action("init")) return $translated;
						/**/
						...
						/**/
						else if ((isset ($s["is_bp_blog_creation"]) && $s["is_bp_blog_creation"]) || (!isset ($s["is_bp_blog_creation"]) && ($s["is_bp_blog_creation"] = (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_create_blog ()) ? true : false)))
							{
