...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_registrations"))
	{
		/**
		* Registration handlers.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_registrations
			{
			...
			{
				$GLOBALS['ws_plugin__optimizemember_custom_password'] = ''; // Initialize.
				$password                                       = trim(stripslashes((string)$password));

				if($password && $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['custom_reg_password'])
				{
					$GLOBALS['ws_plugin__optimizemember_custom_password']         = $password;
					return ($GLOBALS['ws_plugin__optimizemember_plain_text_pass'] = $GLOBALS['ws_plugin__optimizemember_custom_password']);
				}
				if($password && c_ws_plugin__optimizemember_utils_conds::pro_is_installed() && c_ws_plugin__optimizemember_pro_remote_ops::is_remote_op('create_user'))
				{
					$GLOBALS['ws_plugin__optimizemember_custom_password']         = $password;
					return ($GLOBALS['ws_plugin__optimizemember_plain_text_pass'] = $GLOBALS['ws_plugin__optimizemember_custom_password']);
				}
				return ($GLOBALS['ws_plugin__optimizemember_plain_text_pass'] = wp_generate_password());
			}
				/**
				...
				* @return str Password, possibly assigned through optimizeMember Custom Registration/Profile Field input.
				*/
			public static function generate_password($password = '')
			{
				...
				do_action('ws_plugin__optimizemember_before_generate_password', get_defined_vars());
				unset($__refs, $__v); // Housekeeping.

				if (isset($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['ruris_case_sensitive'])
				&& !empty($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['ruris_case_sensitive'])) {
					$ci = '';
				} else {
					$ci = 'i';
				}

				if(!$did_generate_password && !is_admin() && (preg_match('/\/wp-login\.php/'.$ci, $_SERVER['REQUEST_URI']) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed() && bp_is_register_page())))
				{
					$GLOBALS['ws_plugin__optimizemember_custom_wp_login_bp_password'] = false; // Initialize.

					if(!empty($_POST['ws_plugin__optimizemember_custom_reg_field_user_pass1']) && preg_match('/\/wp-login\.php/'.$ci, $_SERVER['REQUEST_URI']))
					{
						$password = self::maybe_custom_pass($_POST['ws_plugin__optimizemember_custom_reg_field_user_pass1']);
						$GLOBALS['ws_plugin__optimizemember_custom_wp_login_bp_password'] = !empty($GLOBALS['ws_plugin__optmizemember_custom_password']) && $password === $GLOBALS['ws_plugin__optimizemember_custom_password'];
					}
					$GLOBALS['ws_plugin__optimizemember_plain_text_wp_login_bp_pass'] = $password; // Plain-text password.
					$GLOBALS['ws_plugin__optimizemember_plain_text_pass']             = $password; // Plain-text password.
				...
				return apply_filters('ws_plugin__optimizemember_generate_password', $password, get_defined_vars());
			}
				/**
				...
				* @return array The Filtered ``$result`` array. Possibly containing errors introduced by optimizeMember.
				*/
				public static function ms_validate_user_signup ($result = FALSE)
					{
						eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action ("ws_plugin__optimizemember_before_ms_validate_user_signup", get_defined_vars ());
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if (!is_admin () && isset ($result["user_name"], $result["user_email"], $result["errors"]) && ((preg_match ("/\/wp-signup\.php/", $_SERVER["REQUEST_URI"]) && !empty ($_POST["stage"]) && preg_match ("/^validate-(user|blog)-signup$/", (string)$_POST["stage"])) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_register_page ())))
								{
									if (in_array ($result["errors"]->get_error_code (), array ("user_name", "user_email", "user_email_used")))
										if (c_ws_plugin__optimizemember_utils_users::ms_user_login_email_exists_but_not_on_blog ($result["user_name"], $result["user_email"]))
											$result["errors"] = new WP_Error ();
									/**/
									eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
									do_action ("ws_plugin__optimizemember_during_ms_validate_user_signup", get_defined_vars ());
									unset ($__refs, $__v); /* Unset defined __refs, __v. */
								}
						/**/
						return apply_filters ("ws_plugin__optimizemember_ms_validate_user_signup", $result, get_defined_vars ());
					}
				/**
				...
				*/
				public static function ms_process_signup_hidden_fields ()
					{
						do_action ("ws_plugin__optimizemember_before_ms_process_signup_hidden_fields", get_defined_vars ());
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if (!is_admin () && !empty ($_POST) && is_array ($_POST) && ((preg_match ("/\/wp-signup\.php/", $_SERVER["REQUEST_URI"]) && !empty ($_POST["stage"]) && preg_match ("/^validate-(user|blog)-signup$/", (string)$_POST["stage"])) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_register_page ())))
								{
									foreach (c_ws_plugin__optimizemember_utils_strings::trim_deep (stripslashes_deep ($_POST)) as $key => $value)
										if (preg_match ("/^ws_plugin__optimizemember_(custom_reg_field|user_new)_/", $key))
									...
									/**/
									do_action ("ws_plugin__optimizemember_during_ms_process_signup_hidden_fields", get_defined_vars ());
								}
						/**/
						do_action ("ws_plugin__optimizemember_after_ms_process_signup_hidden_fields", get_defined_vars ());
						/**/
				...
				* @return array Full ``$meta`` array with optimizeMember Custom Fields included.
				*/
				public static function ms_process_signup_meta ($meta = FALSE)
					{
						...
						/**/
						eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action ("ws_plugin__optimizemember_before_ms_process_signup_meta", get_defined_vars ());
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if (!empty ($_POST) && is_array ($_POST) && ((is_blog_admin () && $pagenow === "user-new.php") || (!is_admin () && ((preg_match ("/\/wp-signup\.php/", $_SERVER["REQUEST_URI"]) && !empty ($_POST["stage"]) && preg_match ("/^validate-(user|blog)-signup$/", (string)$_POST["stage"])) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_register_page ())))))
								{
									c_ws_plugin__optimizemember_email_configs::email_config (); /* Configures `From:` header used in notifications. */
									/**/
									...
									foreach (c_ws_plugin__optimizemember_utils_strings::trim_deep (stripslashes_deep ($_POST)) as $key => $value)
										if (preg_match ("/^ws_plugin__optimizemember_(custom_reg_field|user_new)_/", $key))
											if ($key = preg_replace ("/_user_new_/", "_custom_reg_field_", $key))
												$meta["optimizemember_ms_signup_meta"][$key] = maybe_unserialize ($value);
								}
						/**/
						return apply_filters ("ws_plugin__optimizemember_ms_process_signup_meta", $meta, get_defined_vars ());
					}
				/**
				* Intersects with ``wpmu_activate_signup()`` through optimizeMember's Multisite Networking patch.
				*
				...
				*/
				public static function ms_activate_existing_user ($_error = FALSE, $vars = FALSE)
					{
						eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action ("ws_plugin__optimizemember_before_ms_activate_existing_user", get_defined_vars ());
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						extract ($vars); /* Extract all variables from ``wpmu_activate_signup()`` function. */
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if (!is_admin () && ((preg_match ("/\/wp-activate\.php/", $_SERVER["REQUEST_URI"])) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_activation_page ())))
								{
									if (!empty ($user_id) && !empty ($user_login) && !empty ($user_email) && !empty ($password) && !empty ($meta) && !empty ($meta["add_to_blog"]) && !empty ($meta["new_role"]))
										if (!empty ($user_already_exists) && c_ws_plugin__optimizemember_utils_users::ms_user_login_email_exists_but_not_on_blog ($user_login, $user_email, $meta["add_to_blog"]))
											{
												...
												/**/
												return apply_filters ("ws_plugin__optimizemember_ms_activate_existing_user", array ("user_id" => $user_id, "password" => $password, "meta" => $meta), get_defined_vars ());
											}
								}
						/**/
						return apply_filters ("ws_plugin__optimizemember_ms_activate_existing_user", $_error, get_defined_vars ()); /* Else, return the standardized error. */
					}
			...
			{
				foreach(array_keys(get_defined_vars()) as $__v) $__refs[$__v] =& $$__v;
				do_action('ws_plugin__optimizemember_before_custom_registration_field_errors', get_defined_vars());
				unset($__refs, $__v); // Housekeeping.
				...
				if(!is_admin() && preg_match('/\/wp-login\.php/'.$ci, $_SERVER['REQUEST_URI']))
					...
					{
						foreach(c_ws_plugin__optimizemember_utils_strings::trim_deep(stripslashes_deep($_POST)) as $_key => $_value)
							if(strpos($_key, 'ws_plugin__optimizemember_custom_reg_field_') === 0)
								$input[str_replace('ws_plugin__optimizemember_custom_reg_field_', '', $_key)] = $_value;

						$fields_to_validate = c_ws_plugin__optimizemember_custom_reg_fields::custom_fields_configured_at_level('auto-detection', 'registration', TRUE);
						$validation_errors  = c_ws_plugin__optimizemember_custom_reg_fields::validation_errors(!empty($input) ? $input : array(), $fields_to_validate);
				...
				return apply_filters('ws_plugin__optimizemember_custom_registration_field_errors', $errors, get_defined_vars());
			}
			...
			{
				foreach(array_keys(get_defined_vars()) as $__v) $__refs[$__v] =& $$__v;
				do_action('ws_plugin__optimizemember_before_custom_registration_field_errors_4bp', get_defined_vars());
				unset($__refs, $__v); // Housekeeping.

				if(!is_admin() && c_ws_plugin__optimizemember_utils_conds::bp_is_installed() && bp_is_register_page())
					if(in_array('registration', $GLOBALS['WS_PLUGIN__']['optimizemember']['o']['custom_reg_fields_4bp']))
				...
				public static function configure_user_on_ms_user_activation ($user_id = FALSE, $password = FALSE, $meta = FALSE)
					{
						...
						/**/
						eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action ("ws_plugin__optimizemember_before_configure_user_on_ms_user_activation", get_defined_vars ());
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if ((is_blog_admin () && $pagenow === "user-new.php" && isset ($_POST["noconfirmation"])) || (!is_admin () && ((preg_match ("/\/wp-activate\.php/", $_SERVER["REQUEST_URI"])) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_activation_page ()))))
								{
									c_ws_plugin__optimizemember_registrations::configure_user_registration ($user_id, $password, ((isset ($meta["optimizemember_ms_signup_meta"]) && is_array ($meta["optimizemember_ms_signup_meta"])) ? $meta["optimizemember_ms_signup_meta"] : array ()));
									delete_user_meta ($user_id, "optimizemember_ms_signup_meta");
								}
						/**/
						do_action ("ws_plugin__optimizemember_after_configure_user_on_ms_user_activation", get_defined_vars ());
						/**/
						return; /* Return for uniformity. */
					}
				/**
				...
				*/
				public static function configure_user_on_ms_blog_activation ($blog_id = FALSE, $user_id = FALSE, $password = FALSE, $title = FALSE, $meta = FALSE)
					{
						eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action ("ws_plugin__optimizemember_before_configure_user_on_ms_blog_activation", get_defined_vars ());
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if (!is_admin () && ((preg_match ("/\/wp-activate\.php/", $_SERVER["REQUEST_URI"])) || (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_activation_page ())))
						...
						/**/
						do_action ("ws_plugin__optimizemember_after_configure_user_on_ms_blog_activation", get_defined_vars ());
						/**/
						return; /* Return for uniformity. */
					}
            ...
            {
                foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;
                do_action("ws_plugin__optimizemember_before_bp_user_activation", get_defined_vars ());
                unset($__refs, $__v);

                if(is_multisite() || !$user_id) return; // Nothing to do.

                $role = get_user_option('optimizemember_bp_activation_role', $user_id);
                $ccaps = get_user_option('optimizemember_bp_activation_ccaps', $user_id);

                delete_user_option($user_id, 'optimizemember_bp_activation_role');
                delete_user_option($user_id, 'optimizemember_bp_activation_ccaps');

                if($role && ($user = new WP_User($user_id)) && $user->ID)
                {
                    $user->set_role($role);
                    if($ccaps && is_array($ccaps)) foreach($ccaps as $_ccap)
                        $user->add_cap('access_optimizemember_ccap_'.$_ccap);
                    unset($_ccap); // Housekeeping.
                }
            }

            /**
				* Intersects with ``register_new_user()`` through optimizeMember's Multisite Networking patch.
				*
				* This function Filters registration errors inside `/wp-login.php` via ``register_new_user()``.
				...
				*/
				public static function ms_register_existing_user ($errors = FALSE, $user_login = FALSE, $user_email = FALSE)
					{
						eval ('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action ("ws_plugin__optimizemember_before_ms_register_existing_user", get_defined_vars ());
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if (is_multisite ()) /* This event should ONLY be processed with Multisite Networking. */
							if (!is_admin () && /* `/wp-login.php`? */ preg_match ("/\/wp-login\.php/", $_SERVER["REQUEST_URI"]))
								if (is_wp_error ($errors) && $errors->get_error_codes ()) /* Errors? */
									{
										if (($user_id = c_ws_plugin__optimizemember_utils_users::ms_user_login_email_exists_but_not_on_blog ($user_login, $user_email)))
											{
												...
												if (empty ($other_important_errors_exist)) /* Only if/when NO other important errors exist already. */
													{
														...
														c_ws_plugin__optimizemember_registrations::ms_create_existing_user ($user_login, $user_email, $user_pass, $user_id);
														$GLOBALS['ws_plugin__optimizemember_generate_password_input'] = $GLOBALS['ws_plugin__optimizemember_generate_password_return'] = null;
														$has_custom_password = isset($GLOBALS['ws_plugin__optimizemember_generate_password_input'], $GLOBALS['ws_plugin__optimizemember_generate_password_return'])
														&& $GLOBALS['ws_plugin__optimizemember_generate_password_input'] !== $GLOBALS['ws_plugin__optimizemember_generate_password_return'];
														...
														/**/
														do_action ("ws_plugin__optimizemember_during_ms_register_existing_user", get_defined_vars ());
														/**/
						...
						/**/
						return apply_filters ("ws_plugin__optimizemember_ms_register_existing_user", $errors, get_defined_vars ());
					}
				/**
								...
								if (($user_id || ($user_id = c_ws_plugin__optimizemember_utils_users::ms_user_login_email_exists_but_not_on_blog ($user_login, $user_email))) && $user_pass)
									{
										...
										do_action ("user_register", $user_id); /* So optimizeMember knows a User is registering. */
										/**/
				...
				public static function configure_user_registration ($user_id = FALSE, $password = FALSE, $meta = FALSE)
					{
						...
						if (!isset ($email_config) && ($email_config = true)) /* Anytime this routine is fired; we configure email. */
							c_ws_plugin__optimizemember_email_configs::email_config (); /* Configures `From:` email header. */
						/**/
							...
							if ( /* We MUST have at least ONE of these three arrays. Any of these will do in most cases. */is_array ($_p) || is_array ($meta) || is_array ($rvs))
								...
								if (!(is_multisite () && is_blog_admin () && $pagenow === "user-new.php" && isset ($_p["noconfirmation"]) && is_super_admin () && !is_array ($meta)))
									if (!(preg_match ("/\/wp-activate\.php/", $_SERVER["REQUEST_URI"]) && !is_array ($meta)) /* If activating; we absolutely MUST have a ``$meta`` array. */)
										if (!(c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && bp_is_activation_page () && !is_array ($meta)) /* If activating; MUST have ``$meta``. */)
												...
												if ($user_id && is_object ($user = new WP_User ($user_id)) && !empty ($user->ID) && ($user_id = $user->ID) && ($processed = true))
													{
														...
														$rvs = c_ws_plugin__optimizemember_utils_strings::trim_deep /* Do NOT strip. */ ($rvs);
														/**/
														foreach ($_p as $_key => $_value) /* Scan ``$_p`` vars; adding `custom_reg_field` keys. */
															if (preg_match ("/^ws_plugin__optimizemember_user_new_/", $_key)) /* Look for keys. */
														...
														/**/
														$custom_reg_display_name = $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_display_name"]; /* Can be configured by the site owner. */
														/**/
														if (!is_admin () && (!c_ws_plugin__optimizemember_utils_conds::pro_is_installed () || !c_ws_plugin__optimizemember_pro_remote_ops::is_remote_op ("create_user")) && /* A paying Customer? */ ($reg_cookies = c_ws_plugin__optimizemember_register_access::reg_cookies_ok ()) && extract ($reg_cookies))
															{ /* This routine could be processed through `/wp-login.php?action=register`, `/wp-activate.php`, or `/activate` via BuddyPress`.
																...
																$role = "optimizemember_level" . $level; /* Membership Level. */
																/**/
                                                                ...
                                                                $subscr_baid = (string)@$_pmr['ws_plugin__optimizemember_custom_reg_field_optimizemember_subscr_baid'];
                                                                $subscr_cid  = (string)@$_pmr['ws_plugin__optimizemember_custom_reg_field_optimizemember_subscr_cid'];
																...
																/**/
																if (!($pass = $password)) /* Try optimizeMember's generator. */
                                                                ...
                                                                update_user_option($user_id, 'optimizemember_subscr_baid', $subscr_baid);
                                                                update_user_option($user_id, 'optimizemember_subscr_cid', $subscr_cid);
																...
																if (is_multisite ()) /* Should we handle Main Site permissions and Originating Blog ID#? */
																	{
																		...
																		/**/
																		if (!get_user_meta ($user_id, "optimizemember_originating_blog", true)) /* Recorded yet? */
																...
																if ($current_role !== $role) /* Only if NOT the current Role. */
																	$user->set_role ($role); /* optimizeMember. */
																/**/
																...
																if (($transient = "s2m_" . md5 ("optimizemember_transient_ipn_signup_vars_" . $subscr_id)) && is_array ($ipn_signup_vars = get_transient ($transient)))
																	{
																		update_user_option ($user_id, "optimizemember_ipn_signup_vars", $ipn_signup_vars); /* For future reference. */
														...
														/**/
														else if ((!is_admin() || defined('DOING_AJAX')) && (!c_ws_plugin__optimizemember_utils_conds::pro_is_installed () || !c_ws_plugin__optimizemember_pro_remote_ops::is_remote_op ("create_user")))
															{ /* This routine could be processed through `/wp-login.php?action=register`, `/wp-activate.php`, or `/activate` via BuddyPress`.
																	This may also be processed through a standard BuddyPress installation, or another plugin calling `user_register`.
																	If processed through `/wp-activate.php`, it could've originated inside the admin, via `/user-new.php`. */
																/**/
																...
																if /* Should we handle Main Site permissions and Originating Blog ID#? */(is_multisite ())
																	{
																		...
																		/**/
																		if /* Recorded yet? */(!get_user_meta ($user_id, "optimizemember_originating_blog", true))
																			update_user_meta ($user_id, "optimizemember_originating_blog", $current_blog->blog_id);
																	}
																/**/
																if ($current_role !== $role) /* Only if NOT the current Role. */
														...
														/**/
														else if ((is_blog_admin () && $pagenow === "user-new.php") || (c_ws_plugin__optimizemember_utils_conds::pro_is_installed () && c_ws_plugin__optimizemember_pro_remote_ops::is_remote_op ("create_user")))
