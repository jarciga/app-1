<?php
/**
* Custom Registration/Profile Fields for optimizeMember.
*
* Copyright: © 2009-2011
...
/**/
if(!class_exists("c_ws_plugin__optimizemember_custom_reg_fields"))
	{
		/**
		* Custom Registration/Profile Fields for optimizeMember.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_custom_reg_fields
			{
				/**
				...
				*/
				public static function custom_fields_configured_at_level($_level = "auto-detection", $_editable_context = FALSE, $full_config = FALSE)
					{
						eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action("ws_plugin__optimizemember_before_custom_fields_configured_at_level", get_defined_vars());
						unset($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						$level = ($_level === "auto-detection") ? c_ws_plugin__optimizemember_user_access::user_access_level() : $_level;
						if($_level === "auto-detection" && $level < 0 && ($reg_cookies = c_ws_plugin__optimizemember_register_access::reg_cookies_ok()) && extract($reg_cookies) && preg_match($GLOBALS["WS_PLUGIN__"]["optimizemember"]["c"]["membership_item_number_w_level_regex"], $item_number, $m) && !empty($m[1]) && is_numeric($m[1]))
							$level = /* A numeric Membership Level # . */ $m[1];
						/**/
						$level = ($level !== "any" && (!is_numeric($level) || $level < 0)) ? 0 : /* Default. */ $level;
						/**/
						if(($level === "any" || (is_numeric($level) && $level >= 0)) && $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_fields"])
							{
						...
						/**/
						return apply_filters("ws_plugin__optimizemember_custom_fields_configured_at_level", ((!empty($configured)) ? $configured : array()), get_defined_vars());
					}
				/**
				...
				*/
				public static function ms_custom_registration_fields()
					{
						do_action("ws_plugin__optimizemember_before_ms_custom_registration_fields", get_defined_vars());
						/**/
						if(is_multisite() && is_main_site()) /* Must be Main Site of a Network. */
							{
								...
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_before", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
								/**/
								if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_names"])
									{
										echo '<div class="ws-plugin--optimizemember-custom-reg-field-divider-section"></div>'."\n";
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_before_first_name", get_defined_vars());
										unset($__refs, $__v); /* Unset defined __refs, __v. */
										/**/
										echo '<label for="ws-plugin--optimizemember-custom-reg-field-first-name">'._x("First Name", "s2member-front", "s2member").' *</label>'."\n";
										echo '<input type="text" aria-required="true" maxlength="100" autocomplete="off" name="ws_plugin__optimizemember_custom_reg_field_first_name" id="ws-plugin--optimizemember-custom-reg-field-first-name" class="ws-plugin--optimizemember-custom-reg-field" value="'.esc_attr($_p["ws_plugin__optimizemember_custom_reg_field_first_name"]).'" />'."\n";
										echo '<br />'."\n";
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_after_first_name", get_defined_vars());
										unset($__refs, $__v); /* Unset defined __refs, __v. */
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_before_last_name", get_defined_vars());
										unset($__refs, $__v); /* Unset defined __refs, __v. */
										/**/
										echo '<label for="ws-plugin--optimizemember-custom-reg-field-last-name">'._x("Last Name", "s2member-front", "s2member").' *</label>'."\n";
										echo '<input type="text" aria-required="true" maxlength="100" autocomplete="off" name="ws_plugin__optimizemember_custom_reg_field_last_name" id="ws-plugin--optimizemember-custom-reg-field-last-name" class="ws-plugin--optimizemember-custom-reg-field" value="'.esc_attr($_p["ws_plugin__optimizemember_custom_reg_field_last_name"]).'" />'."\n";
										echo '<br />'."\n";
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_after_last_name", get_defined_vars());
										unset($__refs, $__v); /* Unset defined __refs, __v. */
									}
								/**/
								if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_fields"])
									if($fields_applicable = c_ws_plugin__optimizemember_custom_reg_fields::custom_fields_configured_at_level("auto-detection", "registration"))
										foreach(json_decode($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_fields"], true) as $field)
											{
												eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
												do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_before_custom_fields", get_defined_vars());
												unset($__refs, $__v); /* Unset defined __refs, __v. */
												/**/
												if(in_array($field["id"], $fields_applicable)) /* Field applicable? */
													{
														...
														/**/
														eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
														if(apply_filters("ws_plugin__optimizemember_during_ms_custom_registration_fields_during_custom_fields_display", true, get_defined_vars()))
															{
																if(!empty($field["section"]) && $field["section"] === "yes") /* Starts a new section? */
																	echo '<div class="ws-plugin--optimizemember-custom-reg-field-divider-section'.((!empty($field["sectitle"])) ? '-title' : '').'">'.((!empty($field["sectitle"])) ? $field["sectitle"] : '').'</div>';
																/**/
																echo '<label for="ws-plugin--optimizemember-custom-reg-field-'.esc_attr($field_id_class).'"'.((preg_match("/^(checkbox|pre_checkbox)$/", $field["type"])) ? ' style="display:none;"' : '').'>'.$field["label"].(($field["required"] === "yes") ? ' *' : '').'</label>'.((preg_match("/^(checkbox|pre_checkbox)$/", $field["type"])) ? '<br />' : '')."\n";
																echo c_ws_plugin__optimizemember_custom_reg_fields::custom_field_gen(__FUNCTION__, $field, "ws_plugin__optimizemember_custom_reg_field_", "ws-plugin--optimizemember-custom-reg-field-", "ws-plugin--optimizemember-custom-reg-field", "", "", "", $_p, $_p["ws_plugin__optimizemember_custom_reg_field_".$field_var], "registration");
																echo '<br />'."\n";
															}
														unset($__refs, $__v); /* Unset defined __refs, __v. */
													}
												/**/
												eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
												do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_after_custom_fields", get_defined_vars());
												unset($__refs, $__v); /* Unset defined __refs, __v. */
											}
								/**/
								if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_opt_in"] && c_ws_plugin__optimizemember_list_servers::list_servers_integrated())
									{
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_before_opt_in", get_defined_vars());
										unset($__refs, $__v); /* Unset defined __refs, __v. */
										/**/
										echo '<label for="ws-plugin--optimizemember-custom-reg-field-opt-in">'."\n";
										echo '<input type="checkbox" name="ws_plugin__optimizemember_custom_reg_field_opt_in" id="ws-plugin--optimizemember-custom-reg-field-opt-in" class="ws-plugin--optimizemember-custom-reg-field" value="1"'.(((empty($_p) && $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_opt_in"] == 1) || $_p["ws_plugin__optimizemember_custom_reg_field_opt_in"]) ? ' checked="checked"' : '').' />'."\n";
										echo $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_opt_in_label"]."\n";
										echo '</label>'."\n";
										echo '<br />'."\n";
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_after_opt_in", get_defined_vars());
										unset($__refs, $__v); /* Unset defined __refs, __v. */
									}
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_ms_custom_registration_fields_after", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
							}
						/**/
						eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action("ws_plugin__optimizemember_after_ms_custom_registration_fields", get_defined_vars());
						unset($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
				...
				*/
				public static function custom_registration_fields()
					{
						do_action("ws_plugin__optimizemember_before_custom_registration_fields", get_defined_vars());
						/**/
						$_p = (!empty($_POST)) ? c_ws_plugin__optimizemember_utils_strings::trim_deep(stripslashes_deep($_POST)) : array();
						/**/
						echo '<input type="hidden" name="ws_plugin__optimizemember_registration" value="'.esc_attr(wp_create_nonce("ws-plugin--optimizemember-registration")).'" />'."\n";
						...
						/**/
						eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action("ws_plugin__optimizemember_during_custom_registration_fields_before", get_defined_vars());
						unset($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_password"])
							{
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_before_user_pass", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
								/**/
								echo '<p>'."\n";
								/**/
								echo '<label for="ws-plugin--optimizemember-custom-reg-field-user-pass1" title="'.esc_attr(_x("Please type your Password twice to confirm.", "s2member-front", "s2member")).'">'."\n";
								echo '<span>'._x("Password ( please type it twice )", "s2member-front", "s2member").' *</span><br />'."\n";
								echo '<input type="password" aria-required="true" maxlength="100" autocomplete="off" name="ws_plugin__optimizemember_custom_reg_field_user_pass1" id="ws-plugin--optimizemember-custom-reg-field-user-pass1" class="ws-plugin--optimizemember-custom-reg-field" value="'.format_to_edit($_p["ws_plugin__optimizemember_custom_reg_field_user_pass1"]).'" tabindex="'.esc_attr(($tabindex = $tabindex + 10)).'" />'."\n";
								echo '</label>'."\n";
								/**/
								echo '<label for="ws-plugin--optimizemember-custom-reg-field-user-pass2" title="'.esc_attr(_x("Please type your Password twice to confirm.", "s2member-front", "s2member")).'">'."\n";
								echo '<input type="password" maxlength="100" autocomplete="off" name="ws_plugin__optimizemember_custom_reg_field_user_pass2" id="ws-plugin--optimizemember-custom-reg-field-user-pass2" class="ws-plugin--optimizemember-custom-reg-field" value="'.format_to_edit($_p["ws_plugin__optimizemember_custom_reg_field_user_pass2"]).'" tabindex="'.esc_attr(($tabindex = $tabindex + 10)).'" />'."\n";
								echo '</label>'."\n";
								/**/
								echo '<div id="ws-plugin--optimizemember-custom-reg-field-user-pass-strength" class="ws-plugin--optimizemember-password-strength"><em>'._x("password strength indicator", "s2member-front", "s2member").'</em></div>'."\n";
								/**/
								echo '</p>'."\n";
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_after_user_pass", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
							}
						/**/
						if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_names"])
							{
								...
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_before_first_name", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
								/**/
								echo '<p>'."\n";
								echo '<label for="ws-plugin--optimizemember-custom-reg-field-first-name">'."\n";
								echo '<span>'._x("First Name", "s2member-front", "s2member").' *</span><br />'."\n";
								echo '<input type="text" aria-required="true" maxlength="100" autocomplete="off" name="ws_plugin__optimizemember_custom_reg_field_first_name" id="ws-plugin--optimizemember-custom-reg-field-first-name" class="ws-plugin--optimizemember-custom-reg-field" value="'.esc_attr($_p["ws_plugin__optimizemember_custom_reg_field_first_name"]).'" tabindex="'.esc_attr(($tabindex = $tabindex + 10)).'" />'."\n";
								echo '</label>'."\n";
								echo '</p>'."\n";
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_after_first_name", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_before_last_name", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
								/**/
								echo '<p>'."\n";
								echo '<label for="ws-plugin--optimizemember-custom-reg-field-last-name">'."\n";
								...
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_after_last_name", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
							}
						/**/
						if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_fields"])
							if($fields_applicable = c_ws_plugin__optimizemember_custom_reg_fields::custom_fields_configured_at_level("auto-detection", "registration"))
								{
									...
									foreach(json_decode($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_fields"], true) as $field)
										{
											eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
											do_action("ws_plugin__optimizemember_during_custom_registration_fields_before_custom_fields", get_defined_vars());
											unset($__refs, $__v); /* Unset defined __refs, __v. */
											/**/
											if(in_array($field["id"], $fields_applicable)) /* Field applicable? */
												{
													...
													/**/
													eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
													if(apply_filters("ws_plugin__optimizemember_during_custom_registration_fields_during_custom_fields_display", true, get_defined_vars()))
														{
															if(!empty($field["section"]) && $field["section"] === "yes") /* Starts a new section? */
																echo '<div class="ws-plugin--optimizemember-custom-reg-field-divider-section'.((!empty($field["sectitle"])) ? '-title' : '').'">'.((!empty($field["sectitle"])) ? $field["sectitle"] : '').'</div>';
															/**/
															echo '<p>'."\n";
															echo '<label for="ws-plugin--optimizemember-custom-reg-field-'.esc_attr($field_id_class).'">'."\n";
															...
															echo c_ws_plugin__optimizemember_custom_reg_fields::custom_field_gen(__FUNCTION__, $field, "ws_plugin__optimizemember_custom_reg_field_", "ws-plugin--optimizemember-custom-reg-field-", "ws-plugin--optimizemember-custom-reg-field", "", ($tabindex = $tabindex + 1), "", $_p, $_p["ws_plugin__optimizemember_custom_reg_field_".$field_var], "registration");
															echo '</p>'."\n";
														}
													unset($__refs, $__v); /* Unset defined __refs, __v. */
												}
											/**/
											eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
											do_action("ws_plugin__optimizemember_during_custom_registration_fields_after_custom_fields", get_defined_vars());
											unset($__refs, $__v); /* Unset defined __refs, __v. */
										}
								}
						/**/
						if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_opt_in"] && c_ws_plugin__optimizemember_list_servers::list_servers_integrated())
							{
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_before_opt_in", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
								/**/
								echo '<p>'."\n";
								echo '<label for="ws-plugin--optimizemember-custom-reg-field-opt-in">'."\n";
								echo '<input type="checkbox" name="ws_plugin__optimizemember_custom_reg_field_opt_in" id="ws-plugin--optimizemember-custom-reg-field-opt-in" class="ws-plugin--optimizemember-custom-reg-field" value="1"'.(((empty($_p) && $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_opt_in"] == 1) || $_p["ws_plugin__optimizemember_custom_reg_field_opt_in"]) ? ' checked="checked"' : '').' tabindex="'.esc_attr(($tabindex = $tabindex + 10)).'" />'."\n";
								echo $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["custom_reg_opt_in_label"]."\n";
								echo '</label>'."\n";
								echo '</p>'."\n";
								/**/
								eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
								do_action("ws_plugin__optimizemember_during_custom_registration_fields_after_opt_in", get_defined_vars());
								unset($__refs, $__v); /* Unset defined __refs, __v. */
							}
						/**/
						eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action("ws_plugin__optimizemember_during_custom_registration_fields_after", get_defined_vars());
						unset($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
						do_action("ws_plugin__optimizemember_after_custom_registration_fields", get_defined_vars());
						unset($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						return; /* Return for uniformity. */
					}
            ...
            public static function validation_errors($input, $fields_to_validate)
            {
                ...
                $force_personal_emails    = isset($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['custom_reg_force_personal_emails'][0]) ? TRUE : FALSE;
                $non_personal_email_users = '/^(?:'.implode('|', preg_split('/[\s;,]+/', preg_quote($GLOBALS['WS_PLUGIN__']['optimizemember']['o']['custom_reg_force_personal_emails'], '/'))).'@/i';
                ...
                return apply_filters('c_ws_plugin__optimizemember_custom_reg_field_validation_errors', $errors, get_defined_vars());
            }
			}
	}
?>