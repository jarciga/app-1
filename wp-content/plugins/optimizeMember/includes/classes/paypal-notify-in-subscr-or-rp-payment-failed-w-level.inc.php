...
if (!class_exists ("c_ws_plugin__optimizemember_paypal_notify_in_subscr_or_rp_payment_failed_w_level"))
	{
		/**
		* optimizeMember's PayPal IPN handler (inner processing routine).
		*
		...
		* @since 110720
		*/
		class c_ws_plugin__optimizemember_paypal_notify_in_subscr_or_rp_payment_failed_w_level
			{
				/**
				* optimizeMember's PayPal IPN handler (inner processing routine).
				*
				...
				public static function cp ($vars = array()) // Conditional phase for ``c_ws_plugin__optimizemember_paypal_notify_in::paypal_notify()``.
					{
						...
						else return apply_filters("c_ws_plugin__optimizemember_paypal_notify_in_subscr_or_rp_payment_failed_w_level", false, get_defined_vars ());
					}
			}
	}