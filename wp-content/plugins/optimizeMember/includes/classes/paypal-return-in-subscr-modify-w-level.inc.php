...
if(!class_exists('c_ws_plugin__optimizemember_paypal_return_in_subscr_modify_w_level'))
{
	/**
	 * optimizeMember's PayPal Auto-Return/PDT handler (inner processing routine).
	 *
	 ...
	 * @since 110720
	 */
	class c_ws_plugin__optimizemember_paypal_return_in_subscr_modify_w_level
	{
		/**
		 * optimizeMember's PayPal Auto-Return/PDT handler (inner processing routine).
		 *
		...
		public static function cp($vars = array() /* Conditional phase for ``c_ws_plugin__optimizemember_paypal_notify_in::paypal_notify()``. */)
		{
			...
			)
			{
				...
				do_action('ws_plugin__optimizemember_during_paypal_return_before_subscr_modify', get_defined_vars());
				unset($__refs, $__v);
				...
				{
					$paypal['optimizemember_log'][] = 'optimizeMember `txn_type` identified as ( `subscr_modify` ), a Subscription Modification.';
					...
					if(($user_id = c_ws_plugin__optimizemember_utils_users::get_user_id_with($paypal['subscr_id'])) && is_object($user = new WP_User($user_id)) && $user->ID)
					{
						if(!$user->has_cap('administrator') /* Do NOT process this routine on Administrators. */)
						{
							...
							foreach(array_keys(get_defined_vars()) as $__v) $__refs[$__v] =& $$__v;
							do_action('ws_plugin__optimizemember_during_paypal_return_during_before_subscr_modify', get_defined_vars());
							...
							$paypal['optimizemember_log'][] = 'optimizeMember Level/Capabilities updated on ( `subscr_modify` ), a Subscription Modification.';
							...
							$paypal['optimizemember_log'][] = 'Transient Tracking Cookie set on ( `subscr_modify` ), a Subscription Modification.';
							...
							foreach(array_keys(get_defined_vars()) as $__v) $__refs[$__v] =& $$__v;
							do_action('ws_plugin__optimizemember_during_paypal_return_during_subscr_modify', get_defined_vars());
							unset($__refs, $__v);
							...
							{
								$paypal['optimizemember_log'][] = 'Redirecting this Member to a custom URL after modification: '.$redirection_url_after_modification;
				...
				foreach(array_keys(get_defined_vars()) as $__v) $__refs[$__v] =& $$__v;
				do_action('ws_plugin__optimizemember_during_paypal_return_after_subscr_modify', get_defined_vars());
				unset($__refs, $__v);

				return apply_filters('c_ws_plugin__optimizemember_paypal_return_in_subscr_modify_w_level', $paypal, get_defined_vars());
			}
			else return apply_filters('c_ws_plugin__optimizemember_paypal_return_in_subscr_modify_w_level', FALSE, get_defined_vars());
		}
	}
}