...
*/
add_action("plugins_loaded", "c_ws_plugin__optimizemember_translations::load", 2);
add_action('set_current_user', 'c_ws_plugin__optimizemember_user_securities::set_current_user', 2);
/**/
...
/**/
add_action('admin_init', 'c_ws_plugin__optimizemember_menu_pages::log_file_downloader');
add_action('admin_init', 'c_ws_plugin__optimizemember_menu_pages::logs_zip_downloader');
/**/
...
/**/
add_action("wp_login", "c_ws_plugin__optimizemember_login_redirects::login_redirect", 10, 2);
