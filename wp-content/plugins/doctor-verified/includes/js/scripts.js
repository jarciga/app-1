...
$.validator.addMethod("validateUserEmail", function(value, element)
{
    ...
    $.ajax(
    {
        ...
        url: 'http://puremaca.net/reviewsite5/wp-content/plugins/doctor-verified/check-email.php',
        //url: 'http://localhost/wpplugins/web-seal/check-email.php', //doctorVerifiedParams.ajax_url,
        //url: 'http://puremaca.net/reviewsite5/web-seal/check-email.php', //doctorVerifiedParams.ajax_url,
        //dataType: "json",
        data: { 'emails' : inputElem.val() },
        success: function(data)
        { 
          ...
          rules: {
              ...
              txtEmailID: {
                ...
                {                  
                  ...
                  //url: 'http://puremaca.net/reviewsite5/web-seal/check-email.php',
      ...
      var handler = StripeCheckout.configure({
        ...
        $('#customButton').on('click', function(e) {
          ...
          handler.open({
            ...
            image: 'http://puremaca.net/reviewsite5/wp-content/plugins/doctor-verified/includes/img/marketplace.png',
            //amount: 9995,
