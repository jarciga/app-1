...
function getWebSeal(master_id, div_class_name) {
    ...
    //console.log(master_id + ' ' + div_class_name);
    ...
    function get_seal() {
        ...
        getSealObj.open('GET', 'http://puremaca.net/reviewsite5/web-seal/doctor-verified-web-seal.php?master_id=' + master_id + "&seal_type=" + seal_type, true);
